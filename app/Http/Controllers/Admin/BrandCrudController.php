...
class BrandCrudController extends CrudController {
    ...
    public function setup() {
        ...
        $this->crud->setFromDb();
        $this->crud->setColumns([ 'logo', 'name', 'slug']);
        // ------ CRUD FIELDS        
        /*  $this->crud->addColumn([   // Upload
          ...
          'type' => 'upload',
          'upload' => true,
          'disk' => 'brands' // if you store files in the /public folder, please ommit this; if you store them in /storage or S3, please specify it;
          ]); */
        $this->crud->addColumn([
        ...
        $this->crud->addField([// image
            ...
            'aspect_ratio' => 1, // ommit or set to 0 to allow any aspect ratio
                //   'prefix' => 'images/brands/' // in case you only store the filename in the database, this text will be prepended to the database value
        ]);
    ...
    public function destroy($id) {
        ...
        $families = \App\Models\Family::where(['brandId' => $id]);

        $families->delete();

        $products = \App\Models\Product::where(['brandId' => $id]);
